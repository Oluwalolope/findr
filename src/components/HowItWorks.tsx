  ...
  const steps = [
    {
      ...
      description: "Enter what you need and your location to find nearby stores.",
    },
    {
      icon: ShoppingCart,
      title: "Add to Cart",
      description: "Browse available items, compare prices, and add to your cart.",
    },
    {
      icon: CreditCard,
      title: "Pay Securely",
    ...
    },
    {
      icon: Package,
      title: "Pickup & Go",
      description: "Get notified when ready, show your order code, and pickup instantly.",
    },
  ];

  return (
    <section id="how-it-works" className="py-16 sm:py-24 bg-linear-to-b from-gray-50 to-white">
